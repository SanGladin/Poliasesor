     ...
     <div class="center">
         <div class="todo">
                    ...
                    <div id="columna-izquierda">
                        <div class="caracteristicas agrupadas">
                            ...
                            <div class="sb-columna con-borde" id="cuadro-inicial">
                                ...
                                <textarea class="campos" placeholder="Inscríbete para saber más"readonly name="zoom" 
           ...
           <input type="text" class="aseid" name="idase" style="visibility: hidden; position: fixed" value="<%=a.getId() %>">
                        ...
                        <form  method="Post" id="form1" class="tblHorarios agrupadas"><% System.out.println("la asesoria es la numero:" + a.getId()); 
                    %>
                    ...
                    <input type="submit"  onclick="document.getElementById('form1').setAttribute('action','AsesorPrincipal.jsp')"  class="sub" id="cancelar" value="Regresar">
                    <input type="submit" onclick="document.getElementById('form1').setAttribute('action','inscribirasesoria')" class="sub" id="botonEdicion" value="Inscribir">
                </form>
