     ...
     <div class="todo">
            ...
            <section class="columnas segunda">
                ...
                <input readonly   <%  List<AsesoriaD> datosddf = AccionesUsuario.Obtenerdatosased(id, 7);
                    ...
                    <input type="text" class="aseid" name="idase" style="visibility: hidden; position:fixed;" value="<%=a.getId() %>">
           

                <div class="tblHorarios agrupadas">
                     
                         
                         <form  method="Post" id="form1"><% System.out.println("la asesoria es la numero:" + a.getId()); 
                    String ad = Integer.toString(a.getId());%>
                     <input type="text" class="idase" name="idase" style="visibility: hidden; position: fixed;" value= "<%=ad %>">
     
                <input type="submit" onclick="document.getElementById('form1').setAttribute('action','misasesorias.jsp')"  class="sub" id="cancelar" value="Mis Asesorias"></td>
<input type="submit" onclick="document.getElementById('form1').setAttribute('action','editarasesoria.jsp')" class="sub" id="botonEdicion" value="Editar"></td>
                
                     <input type="button" onclick="return borrartodo(this)" class="sub" id="botonEliminar" value="Borrar">
                        <input type="submit" formaction="lista.jsp" class="sub" id="botonlista" value="Lista">
