        ...
        <div class="todo">
            ...
            <section class="columnas segunda">
                ...
                <div class="tblHorarios agrupadas">
                     <input type="submit" onclick="document.getElementById('form1').setAttribute('action','misasesorias.jsp')"  class="sub" id="cancelar" value="Mis Asesorias">

                    <input type="submit" onclick="document.getElementById('form1').setAttribute('action', 'editarasesoria.jsp')" class="sub" id="botonEdicion" value="Editar">
