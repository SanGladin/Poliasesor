    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try (PrintWriter out = response.getWriter()) {
            ...
            /* TODO output your page here. You may use following sample code. */
             ...
             System.out.println("la boleta es:" +id);
             ...
             e.setId(id);
              ...
              int inscrito = AccionesUsuario.DardeBajaAsesoria(e,usuario);
              if (inscrito >0 ){
                  response.sendRedirect("AsesoriaEliminada.jsp");
              }else if (inscrito == 0){
                   response.sendRedirect("AsesoriaNoEliminada.jsp"); 
              }else {
